...
<head>
    ...
    <title>Edit Trial Student</title>
...
.form-content input[type=text], .form-content input[type=password], .form-content input[type=email], .form-content input[type=url], .form-content input[type=tel], .form-content select {
    width: 100%;
    padding: 9px 20px;
    text-align: left;
    border: 0;
            ...
            <div class="row">
                        ...
                        <div class="form-items">
                            ...
                            <form class="requires-validation" novalidate>    
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control" type="tel" name="tlp" placeholder="Phone Number" required>
                                </div>
               ...
               <div class="col-md-12">
                <select class="form-select mt-3" required>
                   ...
                   <div class="col-md-12">
                        <input class="form-control" type="url" name="idts" placeholder="Room G-meet/Zoom" required>
                    </div>
                          
                                <div class="form-button mt-3">
                                    <button type="button" class="btn btn-warning">Move as Student</button>
